define(['dart_sdk'], function(dart_sdk) {
  ...
  const name$ = dart.privateName(logging, "Logger.name");
  const parent$ = dart.privateName(logging, "Logger.parent");
  const children$ = dart.privateName(logging, "Logger.children");
  ...
  const name$0 = dart.privateName(logging, "Level.name");
  const value$ = dart.privateName(logging, "Level.value");
  let C0;
  let C1;
  let C2;
  let C3;
  ...
  const level$ = dart.privateName(logging, "LogRecord.level");
  const message$ = dart.privateName(logging, "LogRecord.message");
  const object$ = dart.privateName(logging, "LogRecord.object");
  const loggerName$ = dart.privateName(logging, "LogRecord.loggerName");
  const time = dart.privateName(logging, "LogRecord.time");
  const sequenceNumber = dart.privateName(logging, "LogRecord.sequenceNumber");
  const error$ = dart.privateName(logging, "LogRecord.error");
  const stackTrace$ = dart.privateName(logging, "LogRecord.stackTrace");
  const zone$ = dart.privateName(logging, "LogRecord.zone");
